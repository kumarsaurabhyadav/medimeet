    ...
    <div>
      <Card className="bg-muted/20 border-emerald-900/20">
        <CardHeader>
          ...
          <CardDescription>
            Manage incoming applications and verify qualified professionals
          </CardDescription>
          <CardDescription>
            You have {doctors.length} application{doctors.length > 1 ? "s" : ""} awaiting verification
          </CardDescription>
        </CardHeader>
        <CardContent>
          {doctors.length === 0 ? (
            ...
            <div className="space-y-4">
              {[...doctors].sort((a, b) => new Date(b.createdAt) - new Date(a.createdAt)).map((doctor) => (
                <Card
                  key={doctor.id}
                  ...
                  <CardContent className="p-4">
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                      ...
                      <div className="flex items-center gap-2 self-end md:self-auto">
                        <Badge
                          variant="outline"
                          className="bg-purple-900/20 border-purple-900/30 text-purple-300"
                        >
                          Awaiting Review
                        </Badge>
                        <Button
        ...
        <Dialog open={!!selectedDoctor} onOpenChange={handleCloseDialog}>
          <DialogContent className="max-w-3xl">
            <DialogHeader>
              ...
              <DialogDescription>
                Examine qualifications and background information before approval
              </DialogDescription>
            </DialogHeader>
            ...
            <DialogFooter className="flex sm:justify-between">
              ...
              {loading && <div className="text-sm text-muted-foreground mt-2">Updating status...</div>}
            </DialogFooter>
          </DialogContent>
        </Dialog>
      )}
