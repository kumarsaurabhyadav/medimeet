...
export default function DoctorProfile({ doctor, availableDays }) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-[1fr_2fr] gap-6 w-full">
      ...
      <div className="col-span-full md:col-span-1 md:col-start-2 w-full space-y-6">
        <Card className="w-full border-emerald-900/30 bg-emerald-950/30 backdrop-blur-md rounded-xl shadow-lg">
          <CardHeader>
