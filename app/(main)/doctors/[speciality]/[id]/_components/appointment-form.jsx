  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <div aria-live="polite" className="sr-only">
        {loading ? "Booking appointment..." : data?.success && "Appointment booked successfully!"}
      </div>
      ...
      <div className="space-y-2">
        ...
        <Textarea
          ...
          className="bg-background border-emerald-900/20 h-32 hover:border-emerald-500 focus:ring-emerald-500"
        />
